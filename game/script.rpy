...
#DAY 2
    label day2:
        ...
        label printer2fixed:
            ...
            d "Gabe, it's allright I'll-"
            m "Fine. We'll continue this conversation some other time. I'm quite {i}busy{/i} at the moment anyways."
            m "Besides, I doubt the time we have left today would be enough to discuss what needs to be adressed."
            ...
            m "Then you'd better get on with that as soon as whatever this {i}urgent.{/i} matter is has been discussed"
            ...
            m "Don't think yo can run from this conversation like yesterday."
            d "I'm sorry. Of course."
            d "See you around."
            scene bg_office_computer
            g "Phew! That was a close one. Looked like Matt was about to rip you to pieces"
            d "Looked like? I was scared he was about to end my carreer right there on the spot."
            g "He can't do that I think. Higherups have to look over things like that."
            d "How are you not scared of him. I was about to cry. I could have never stood up to him like that."
            g ""
