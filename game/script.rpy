    ...
    label day3:
            ...
            label deskpostcard:
                ...
                if dinner_plans ==True:
                    ...
                    if call_police == True:
                        ...
                        d_t "The girl that went missing lived close to me..."
                        ...
                        d_t "Simon said she suddenly wanted to quit and wouldn't talk about it. Maybe it had something to do with someone from work."
                        ...
                        d_t "The knocking..."
                        d_t "She lives really close to me and now that she's gone I hear knocking?"
                        d_t "She hasn't come in to the office."
                        d_t "She didn't tell anyone why she was leaving."
                        d_t "She left all her things."
                        d_t "This doesn't sound good."
                        d_t "Did that \"he\" she keeps mentioning do something to her?"
                        d_t "..."
                        d_t "Is he after me now...?"
                        d_t "He was at my apartment yesterday."
                        d_t "Oh my god. She's been trying to warn me about this. It's happening to me too now."
                        ...
                        d_t "I have to find a way to change whatever it is she sais is going to happen!"
                        d_t "There has to be a way to get out of this."
                        d_t "But, I can't just lock myself in at home"
                        d_t "I need this job"
                        d_t "I have to figure this out along side work somehow. I can't mess this up."
        ...
        label party:
            ...
            if open_door == True and call_police == False:
                ...
                d "I wanted to go talk to him about it but he wasn't there when I went to go check."
                d "He said he'd be there almost the entire day but I guess something ust have come up."
                g "Aw man. That sucks."
                ...
                d "Thank you."
                s "Oh? What the matter? It sounds rather serious."
                ...
                s "I'll have confront him about it. I think he's here too tonight."
                d "Of course."
                d "I was able to start picking up her work as well by the way."
                s "Really! Thats awesome. We'll take a look at it tomorrow moring then. I'm excited to see it."
                d "Sure."
                if call_police == True:
                    "Ring!"
